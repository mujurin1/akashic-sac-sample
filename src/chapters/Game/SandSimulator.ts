...
export class SandSimulator extends Chapter {
  ...
  update() {
    ...
    // if (this.sandbox.updateCount % 3 === 0 && this.sandbox.updateCount < 600) {
    //   this.sandbox.setPixel_XY(Pixel.coal, 10, 1);
    //   this.sandbox.setPixel_XY(Pixel.sand, 15, 1);
    //   this.sandbox.setPixel_XY(Pixel.sand, 40, 1);
    //   this.sandbox.setPixel_XY(Pixel.coal, 45, 1);
    // }
    // if (this.sandbox.updateCount % 2 === 0 && this.sandbox.updateCount < 300) {
    //   this.sandbox.setPixel_XY(Pixel.water, 30, 1);
    //   this.sandbox.setPixel_XY(Pixel.water, 31, 1);
    //   this.sandbox.setPixel_XY(Pixel.water, 32, 1);
    // }

    // if (
    //   this.sandbox.updateCount % 2 === 0 &&
    //   this.sandbox.updateCount > 600 &&
    //   this.sandbox.updateCount < 700
    // ) {
    //   this.sandbox.setPixel_XY(Pixel.dirt, 31, 1);
    // }
